...
export default function SaleInvoice() {
  ...
  const addItem = () => {
    setInvoice({
      ...invoice,
      items: [...invoice.items, { description: '', quantity: 1, rate: 0, amount: 0, gst_rate: 18, gst_amount: 0 }]
    })
  }
  ...
  const totalGst = invoice.items.reduce((sum, item) => sum + item.gst_amount, 0)
    ...
    try {
      ...
      const { data: txn, error: txnError } = await supabase
        ...
        .insert({
          ...
          amount: subtotal,
          gst_rate: invoice.items[0]?.gst_rate || 0,
          gst_amount: totalGst,
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
              <label className="block text-black font-semibold mb-1">Invoice Number</label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setInvoice({ ...invoice, party_name: e.target.value })}
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              onChange={(e) => setInvoice({ ...invoice, narration: e.target.value })}
